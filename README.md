...
ENGRIPPA is an artificial intelligence engine which spawns virtual machines, intended as alternative for artificial and or deep neural networks.   
...
through analysis of the microprocessor's Program Status Word Register (PSW) against the lhs input stream.
